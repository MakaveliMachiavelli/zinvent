...
import { z } from 'zod';
import type { ProductId, Currency, TaxMode, Frequency } from '../types';
...
export function validateProductData<T>(schema: z.ZodSchema<T>, data: unknown): { success: boolean; data?: T; errors?: z.ZodError } {
...
export function validateUnlockCode(product: ProductId, code: string): boolean {
...
export const PRODUCT_DATA_SCHEMAS: Record<ProductId, z.ZodSchema> = {
...
export function getProductSchema(product: ProductId): z.ZodSchema {
